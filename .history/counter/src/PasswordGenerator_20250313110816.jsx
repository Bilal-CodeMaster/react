 ...
 <div className='flex gap-1 justify-center items-center'>  
  <input type="range" id='length' value={length}
    ...
    <label htmlFor="length">Length {length}</label>
     ...
     <div className='flex gap-1 justify-center items-center'> 
       <input type="select" id='isCharSelected' value={isCharSelected}
    onChange={(e)=>setIsCharSelected(e.target.value)}
    /> 
    <label htmlFor="isCharSelected">isCharSelected {isCharSelected}</label>
    </div> 
</div>
    </div>
    </>
