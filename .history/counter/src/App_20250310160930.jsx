...
const handleColor=(props)=>{
  ...
  return (
    <>
    <div className='w-full min-h-screen  flex justify-center items-center flex-col gap-1 mt-28'
    style={{backgroundColor:color}}
    >
      <div
       className='fixed left-3  flex flex-wrap flex-col justify-center bg-white w-40 p-3 rounded-4xl'
